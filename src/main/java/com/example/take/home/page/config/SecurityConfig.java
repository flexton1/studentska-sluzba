package com.example.take.home.page.config;
    ...
    public void configure(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.cors().and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .permitAll()
                        .antMatchers(HttpMethod.POST, "/api/student/edit")
                        .permitAll()
                        .antMatchers(HttpMethod.POST, "/api/student/status")
                        .permitAll()
                        .antMatchers(HttpMethod.GET, "/api/student/tabela/**")
                        .permitAll()
                        ...
                        .permitAll()
                        .antMatchers(HttpMethod.DELETE, "/api/student/delete/**")
                        .permitAll()
